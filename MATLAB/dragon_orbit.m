...
[t,y] = ode45(@(t,y) orb_prop(y,mu,I,rho), tspan, initCond, opts);
...
function drdt = orb_prop(r,mu, I, rho)

drdt(1:6,1) = [r(4:6); -mu*r(1:3)/norm(r(1:3))^3];
drdt(7:9,1) = -I\cross(r(7:9), I*r(7:9) + rho);
